...
\begin{frame}{Example 2: Choice set for ground water quality}
  ...
  \note{\textbf{EXAMPLE 2:}\\
    Marginal willingness to pay per household is deduced from elaborate questionnaires such as the one containing this choice set regarding different proposed policies to improve ground water quality.
  }
\end{frame}