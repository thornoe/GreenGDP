...
Label:      Construct and map longitudinal data of ecological status of coastal waters.
...
Usage:      This sandbox is line-by-line implementation of the script supporting 
            WaterbodiesScriptTool in the gis.tbx toolbox, however, for coastal waters only. See GitHub.com/ThorNoe/GreenGDP for instructions to run or update it.
